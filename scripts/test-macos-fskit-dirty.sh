...
{"tree":[{"path":"agent","type":"dir","mode":${agent_mode}},{"path":"agent/workspace","type":"dir","mode":${workspace_mode}},{"path":"agent/workspace/copied.txt","type":"file","mode":420,"size":4,"digest":"sha256:${copied_digest}"},{"path":"agent/workspace/copied-link","type":"symlink","mode":${copied_link_mode},"digest":"sha256:${copied_link_digest}","linkname":"target.txt"}]}
JSON
